             ...
             <div class="top-bar">
                ...
                <div class="tab-user">
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(url('/home')); ?>"><i class="fas fa-user"></i> Profile</a>
                ...
                <a href="<?php echo e(route('create')); ?>"><i class="fas fa-pencil-alt"></i>Đăng Tin </a>
                 </div>
             </div>
...
</html><?php /**PATH C:\xampp\htdocs\TN\resources\views/welcome.blade.php ENDPATH**/ ?>